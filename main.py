...
# # DEFINE FEATURES (ORDER REQUIRED FOR MODEL)
...
# # PYDANTIC MODEL — STRICT SCHEMA FOR REQUEST BODY
...
# def check_transaction_risk(transaction: dict):
...
#     result = {"probability": float(prob), "risk": str(risk) , "isAnamoly": isAnamoly}
...
#     version="1.0",
#     description="A robust ML-powered fraud detection API."
# )
...
#     result = check_transaction_risk(transaction.dict())
#     return result
